...
namespace SpaceShipExtras.Utility {
    public class TIDeepSpaceMaintenanceProject : TIProjectTemplate {
        public TIDeepSpaceMaintenanceProject() {
            base.dataName = "Project_DeepSpaceMaintenance";
            base.friendlyName = "Deep Space Maintenance";
